  ...
  <xsl:template match="/">
    <html>
      ...
      <body>
        ...
        <hr size="2"/>
        <p><a href="#packages">Packages</a> - <a href="#objects">Objects</a> - <a href="#functions">Functions</a></p>
        <hr size="2"/>
        <xsl:apply-templates/>
      </body>
    </html>
  ...
  <xsl:template match="objects">
    ...
    <table class="details" border="0" width="100%">
      ...
      <xsl:apply-templates select="object">
	    <xsl:sort select="ncss" order="descending" data-type="number" />
      </xsl:apply-templates>
      <tr>
  ...
  <xsl:template match="functions">
    ...
    <table class="details" border="0" width="100%">
      ...
      <xsl:apply-templates select="function">
	    <xsl:sort select="ccn" order="descending" data-type="number" />
      </xsl:apply-templates>
      <tr>
