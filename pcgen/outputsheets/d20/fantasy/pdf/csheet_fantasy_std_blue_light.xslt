...
<xsl:stylesheet
	...
	<myAttribs:myAttribs>
		...
		<light color="black" background-color="white" border-color="#555588"/>
		<medium color="black" background-color="#eeeeff" border-color="#555588"/>
		<dark color="black" background-color="#ccccff" border-color="#555588"/>
		<very.dark color="black" background-color="#bbbbee" border-color="#555588"/>
		<inverse color="black" background-color="#bbbbee" border-color="#555588"/>
