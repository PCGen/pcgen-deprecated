...
<xsl:stylesheet
	...
	<myAttribs:myAttribs>
		...
		<normal color="black" background-color="white" border-color="#008800"/>
		<light color="black" background-color="white" border-color="#008800"/>
		<medium color="black" background-color="#eeffee" border-color="#008800"/>
		<dark color="black" background-color="#ccffcc" border-color="#008800"/>
		<very.dark color="black" background-color="#44cc44" border-color="#008800"/>
		<inverse color="black" background-color="#44cc44" border-color="#008800"/>

		<bio display-align="after" color="black" background-color="transparent" border-color="#008800"></bio>
