...
<xsl:stylesheet
	...
	<myAttribs:myAttribs>
		...
		<normal color="black" background-color="white" border-color="#880000"/>
		<light color="black" background-color="white" border-color="#880000"/>
		<medium color="black" background-color="#ffeeee" border-color="#880000"/>
		<dark color="black" background-color="#ffcccc" border-color="#880000"/>
		<very.dark color="black" background-color="#cc0000" border-color="#880000"/>
		<inverse color="black" background-color="#cc0000" border-color="#880000"/>

		<bio display-align="after" color="black" background-color="transparent" border-color="#880000"></bio>
