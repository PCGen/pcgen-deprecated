...
<xsl:stylesheet
	...
	<myAttribs:myAttribs>
		...
		<normal color="black" background-color="white" border-color="#888800"/>
		<light color="black" background-color="white" border-color="#888800"/>
		<medium color="black" background-color="#ffffee" border-color="#888800"/>
		<dark color="black" background-color="#ddddbb" border-color="#888800"/>
		<very.dark color="black" background-color="#ccccaa" border-color="#888800"/>
		<inverse color="black" background-color="#888800" border-color="#888800"/>

		<bio display-align="after" color="black" background-color="transparent" border-color="#888800"></bio>
