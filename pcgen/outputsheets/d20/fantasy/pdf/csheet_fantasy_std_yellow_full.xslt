...
<xsl:stylesheet
	...
	<myAttribs:myAttribs>
		...
		<normal color="black" background-color="white" border-color="#888855"/>
		<light color="black" background-color="#ffffdd" border-color="#888855"/>
		<medium color="black" background-color="#eeeecc" border-color="#888855"/>
		<dark color="black" background-color="#ddddbb" border-color="#888855"/>
		<very.dark color="black" background-color="#ccccaa" border-color="#888855"/>
		<inverse color="black" background-color="#bbbb99" border-color="#888855"/>

		<bio display-align="after" color="black" background-color="transparent" border-color="#888855"></bio>
