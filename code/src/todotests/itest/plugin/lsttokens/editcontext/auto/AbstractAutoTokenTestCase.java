		...
		AbstractGlobalTokenTestCase
{
	...
	public void testInvalidInputTypeEmpty() throws PersistenceLayerException
	{
		assertFalse(getToken().parse(primaryContext, primaryProf,
				getSubTokenString() + "|" + getTypePrefix() + "TYPE="));
	}
	...
	{
		assertFalse(getToken().parse(primaryContext, primaryProf,
				getSubTokenString() + "|" + getTypePrefix() + "TYPE=One."));
	}
	...
	{
		assertFalse(getToken().parse(primaryContext, primaryProf,
				getSubTokenString() + "|" + getTypePrefix() + "TYPE=One..Two"));
	}
	...
	// getSubTokenString() + "|" + getTypePrefix() + "TYPE=TestType"));
	// assertFalse(primaryContext.ref.validate());
	// }
	// }
	//
			...
			throws PersistenceLayerException
	{
		...
		assertTrue(getToken().parse(
				primaryContext,
				primaryProf,
				getSubTokenString() + "|TestWP1|" + getTypePrefix()
						+ "TYPE=TestType|TestWP2"));
		assertFalse(primaryContext.ref.validate());
	}
	...
	public void testValidInputs() throws PersistenceLayerException
	{
		...
		assertTrue(getToken().parse(
				primaryContext,
				primaryProf,
				getSubTokenString() + "|TestWP1|TestWP2|" + getTypePrefix()
						+ "TYPE=TestType"));
		assertTrue(primaryContext.ref.validate());
		assertTrue(getToken().parse(
				primaryContext,
