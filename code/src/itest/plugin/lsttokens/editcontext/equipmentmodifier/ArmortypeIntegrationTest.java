...
import plugin.lsttokens.equipmentmodifier.ArmortypeToken;

public class ArmortypeIntegrationTest extends
		AbstractIntegrationTestCase<EquipmentModifier>
{
	...
	public void testRoundRobinSimple() throws PersistenceLayerException
	{
		...
		commit(testCampaign, tc, "Light|Medium");
		commit(modCampaign, tc, "Light|Heavy");
	...
	public void testRoundRobinRemove() throws PersistenceLayerException
	{
		...
		TestContext tc = new TestContext();
		commit(testCampaign, tc, "Light|Medium");
		commit(modCampaign, tc, "Heavy|Medium");
		completeRoundRobin(tc);
	}
	...
	public void testRoundRobinNoSet() throws PersistenceLayerException
	{
		...
		commit(modCampaign, tc, "Light|Medium");
		completeRoundRobin(tc);
	}
	...
	public void testRoundRobinNoReset() throws PersistenceLayerException
	{
		verifyCleanStart();
		TestContext tc = new TestContext();
		commit(testCampaign, tc, "Light|Heavy");
