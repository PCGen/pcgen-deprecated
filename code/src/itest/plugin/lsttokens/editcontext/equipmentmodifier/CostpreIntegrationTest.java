...
import plugin.lsttokens.equipmentmodifier.CostpreToken;

public class CostpreIntegrationTest extends
		AbstractFormulaIntegrationTestCase<CDOMEqMod>
{

	static CostpreToken token = new CostpreToken();
