...
/*
 * 
 * CCSkillLstTest.class, CSkillLstTest.class, DefineLstTest.class,
 * DescispiLstTest.class, DescLstTest.class, DrLstTest.class, KeyLstTest.class,
...
public class GlobalIntegrationTestSuite extends TestSuite
{
