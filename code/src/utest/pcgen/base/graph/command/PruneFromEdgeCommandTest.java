...
public class PruneFromEdgeCommandTest extends ComplexCommandTestCase {
	...
	protected void setUp() throws Exception {
		super.setUp();
		factory = new PruneFromEdgeCommand<Integer, DefaultDirectionalGraphEdge<Integer>>(
				"PruneCmd", graph, edge1);
	}
	...
	public void testGetPresentationName() {
		...
		assertEquals(
				"Prune from Edge",
				new PruneFromEdgeCommand<Integer, DefaultDirectionalGraphEdge<Integer>>(
						null, graph, edge1).getPresentationName());
	}
