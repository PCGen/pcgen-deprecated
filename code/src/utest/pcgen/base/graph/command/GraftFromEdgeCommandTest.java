...
import pcgen.base.graph.command.GraftFromEdgeCommand;
...
public class GraftFromEdgeCommandTest extends ComplexCommandTestCase {
	...
	protected void setUp() throws Exception {
		...
		factory = new GraftFromEdgeCommand<Integer, DefaultDirectionalGraphEdge<Integer>>(
				"GraftCmd", graph, edge1, destination);
	}
	...
	public void testGetPresentationName() {
		...
		assertEquals(
				"Graft From Edge",
				new GraftFromEdgeCommand<Integer, DefaultDirectionalGraphEdge<Integer>>(
						null, graph, edge1, destination).getPresentationName());
	}

	public void testConstructor() {
		try {
			new GraftFromEdgeCommand<Integer, DefaultDirectionalGraphEdge<Integer>>(
					"edit", null, edge1, destination);
			fail();
	...
	public void testGraft() {
		...
		assertFalse(destination.containsNode(node8));
		assertFalse(destination.containsNode(node9));
		assertTrue(destination.containsEdge(edge1));
		assertFalse(destination.containsEdge(edge2));
