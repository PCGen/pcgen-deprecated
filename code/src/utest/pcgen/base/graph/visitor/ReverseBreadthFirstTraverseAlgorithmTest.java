 ...
 */
public class ReverseBreadthFirstTraverseAlgorithmTest extends TestCase
{
	...
	ReverseDirectedBreadthFirstTraverseAlgorithm d2;
	...
	protected void setUp() throws Exception
	{
		...
		dedge6 =
				new TestDirectionalEdge(new Integer[]{node8, node9},
		...
		dedgec = new TestDirectionalEdge(new Integer[]{nodef}, new Integer[]{});
		g2.addNode(node1);
		g2.addNode(node2);
		g2.addNode(node3);
		g2.addNode(node4);
		...
		g2.addEdge(dedgeb);
		g2.addEdge(dedgec);
		d2 = new ReverseDirectedBreadthFirstTraverseAlgorithm(g2);
	}
