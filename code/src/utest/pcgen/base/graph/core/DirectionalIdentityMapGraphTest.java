 ...
 */
public class DirectionalIdentityMapGraphTest extends
		AbstractGraphTestCase<DirectionalEdge<Integer>>
{

	//TODO Need to test .equals behavior on nodes and == on edges
	
	private DirectionalIdentityEdgeMapGraph<Integer, DirectionalEdge<Integer>> strategy;
	...
	protected void setUp() throws Exception
	{
		super.setUp();
		strategy =
				new DirectionalIdentityEdgeMapGraph<Integer, DirectionalEdge<Integer>>();
	}
	...
	public void testHasInwardEdgeList()
	{
		...
		DirectionalEdge<Integer> edge5 =
				new DefaultDirectionalHyperEdge<Integer>(Collections
					.singletonList(node4), new ArrayList<Integer>());
