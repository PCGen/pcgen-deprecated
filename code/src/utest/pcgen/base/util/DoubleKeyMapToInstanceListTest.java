...
public class DoubleKeyMapToInstanceListTest extends TestCase {
	...
	public void testRemoveFromListFor() {
		assertFalse(dkm.removeFromListFor(Integer.valueOf(1), Double.valueOf(1), CONST_D));
		populate();
		assertTrue(dkm.removeFromListFor(Integer.valueOf(1), Double.valueOf(1), CONST_A));
		assertTrue(dkm.containsListFor(Integer.valueOf(1), Double.valueOf(1)));
		assertEquals(1, dkm.sizeOfListFor(Integer.valueOf(1), Double.valueOf(1)));
		assertFalse(dkm.removeFromListFor(Integer.valueOf(1), Double.valueOf(1), CONST_A));
		assertTrue(dkm.removeFromListFor(Integer.valueOf(1), Double.valueOf(1), CONST_B));
		assertEquals(0, dkm.sizeOfListFor(Integer.valueOf(1), Double.valueOf(1)));
		assertFalse(dkm.containsListFor(Integer.valueOf(1), Double.valueOf(1)));
		
		//add a second :)
		dkm.addToListFor(Integer.valueOf(1), Double.valueOf(2), CONST_C);
		assertFalse(dkm.removeFromListFor(Integer.valueOf(1), Double.valueOf(2), CONST_A));
		assertTrue(dkm.containsListFor(Integer.valueOf(1), Double.valueOf(2)));
		assertEquals(2, dkm.sizeOfListFor(Integer.valueOf(1), Double.valueOf(2)));
		assertFalse(dkm.removeFromListFor(Integer.valueOf(1), Double.valueOf(2), CONST_A));
		assertTrue(dkm.removeFromListFor(Integer.valueOf(1), Double.valueOf(2), CONST_C));
		assertEquals(1, dkm.sizeOfListFor(Integer.valueOf(1), Double.valueOf(2)));
		assertTrue(dkm.containsListFor(Integer.valueOf(1), Double.valueOf(2)));
		assertTrue(dkm.removeFromListFor(Integer.valueOf(1), Double.valueOf(2), CONST_C));
		assertEquals(0, dkm.sizeOfListFor(Integer.valueOf(1), Double.valueOf(2)));
	...
	public void testContainsInList() {
		assertFalse(dkm.containsInList(Integer.valueOf(1), Double.valueOf(1), CONST_D));
		populate();
		assertFalse(dkm.containsInList(Integer.valueOf(1), Double.valueOf(16), CONST_D));
		assertTrue(dkm.containsInList(Integer.valueOf(1), Double.valueOf(1), CONST_A));
		assertTrue(dkm.containsInList(Integer.valueOf(1), Double.valueOf(1), CONST_B));
		
		//add a second :)
		dkm.addToListFor(Integer.valueOf(1), Double.valueOf(2), CONST_C);
		assertFalse(dkm.containsInList(Integer.valueOf(1), Double.valueOf(2), CONST_A));
		assertTrue(dkm.containsInList(Integer.valueOf(1), Double.valueOf(2), CONST_C));

		//Test null stuff :)
		assertTrue(dkm.containsInList(Integer.valueOf(2), Double.valueOf(2), null));
	...
	public void testInstanceBehavior() {
		...
		assertFalse(dkm.containsInList(i1, d1, ca1));
		assertFalse(dkm.removeFromListFor(i1, d1, ca1));
		assertTrue(dkm.containsInList(i1, d1, ca));
		
		assertTrue(dkm.containsInList(i2, d1, ca));
		assertFalse(dkm.containsInList(i2, d1, ca1));
		assertFalse(dkm.removeFromListFor(i2, d1, ca1));
		assertTrue(dkm.containsInList(i2, d1, ca));
