...
public class PreBirthPlaceTesterTest extends TestCase
{

	PreBirthPlaceTester tester = new PreBirthPlaceTester();
	...
	public void testCharacter() throws PrerequisiteException
	{
		...
		pc.setStringFor(pcgen.core.utils.StringKey.BIRTHPLACE, "Australia");
