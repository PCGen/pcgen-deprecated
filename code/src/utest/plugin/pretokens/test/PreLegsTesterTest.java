...
public class PreLegsTesterTest extends AbstractCDOMPreTestTestCase<CDOMRace>
{
	...
	public void testRace() throws PrerequisiteException
	{
		...
		human.put(IntegerKey.LEGS, Integer.valueOf(2));
		assertEquals(1, getTest().passesCDOM(prereq, pc));
		prereq.setOperator(PrerequisiteOperator.NEQ);
		assertEquals(1, getTest().passesCDOM(prereq, pc));
		prereq.setOperator(PrerequisiteOperator.LTEQ);
		...
		assertEquals(0, getTest().passesCDOM(prereq, pc));
		prereq.setOperator(PrerequisiteOperator.GTEQ);
		human.put(IntegerKey.LEGS, Integer.valueOf(0));
		assertEquals(0, getTest().passesCDOM(prereq, pc));
		prereq.setOperator(PrerequisiteOperator.NEQ);
		assertEquals(1, getTest().passesCDOM(prereq, pc));
		prereq.setOperator(PrerequisiteOperator.LTEQ);
	...
	public void testRaceTemplate() throws PrerequisiteException
	{
		...
		prereq.setOperator(PrerequisiteOperator.GTEQ);
		human.put(IntegerKey.LEGS, Integer.valueOf(0));
		templ.put(IntegerKey.LEGS, Integer.valueOf(4));
		assertEquals(1, getTest().passesCDOM(prereq, pc));
		prereq.setOperator(PrerequisiteOperator.NEQ);
		assertEquals(1, getTest().passesCDOM(prereq, pc));
		prereq.setOperator(PrerequisiteOperator.LTEQ);
		...
		assertEquals(0, getTest().passesCDOM(prereq, pc));
		prereq.setOperator(PrerequisiteOperator.GTEQ);
		human.put(IntegerKey.LEGS, Integer.valueOf(4));
		templ.put(IntegerKey.LEGS, Integer.valueOf(0));
		assertEquals(0, getTest().passesCDOM(prereq, pc));
		prereq.setOperator(PrerequisiteOperator.NEQ);
		assertEquals(1, getTest().passesCDOM(prereq, pc));
		prereq.setOperator(PrerequisiteOperator.LTEQ);
