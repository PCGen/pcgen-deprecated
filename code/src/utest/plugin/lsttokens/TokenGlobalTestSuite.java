...
@RunWith(Suite.class)
@Suite.SuiteClasses({AbilityLstTest.class, CCSkillLstTest.class,
	ChangeProfLstTest.class, CompanionListLstTest.class, CSkillLstTest.class,
	DefineLstTest.class, DescispiLstTest.class, DescLstTest.class,
	//DrLstTest.class,
	FollowersLstTest.class, KeyLstTest.class,
	KitLstTest.class, LangAutoLstTest.class, MoveLstTest.class,
	MoveCloneLstTest.class, NameispiLstTest.class, 
	//NaturalAttacksLstTest.class,
	OutputNameLstTest.class, 
	//QualifyTokenTest.class,
	RegionLstTest.class,
	...
	//SpellLevelLstTest.class,
	SpellsLstTest.class, SrLstTest.class,
