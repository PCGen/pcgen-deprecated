...
@RunWith(Suite.class)
@Suite.SuiteClasses({CCSkillLstTest.class, CompanionListLstTest.class,
	CSkillLstTest.class, DefineLstTest.class, DescispiLstTest.class,
	DescLstTest.class, DrLstTest.class, KeyLstTest.class, KitLstTest.class,
