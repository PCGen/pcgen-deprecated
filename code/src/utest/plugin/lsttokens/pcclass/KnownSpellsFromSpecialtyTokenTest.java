...
public class KnownSpellsFromSpecialtyTokenTest extends
		AbstractIntegerTokenTestCase<CDOMPCClass>
{

	static KnownspellsfromspecialtyToken token =
			new KnownspellsfromspecialtyToken();
