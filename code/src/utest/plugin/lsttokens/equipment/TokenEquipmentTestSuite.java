...
@Suite.SuiteClasses({AcCheckTokenTest.class, AltCritMultTokenTest.class,
	...
	BaseqtyTokenTest.class, CostTokenTest.class, CritMultTokenTest.class,
	...
	QualityTokenTest.class, RangeTokenTest.class, RateOfFireTokenTest.class,
	ReachMultTokenTest.class, ReachTokenTest.class, SlotsTokenTest.class,
	SpellfailureTokenTest.class, SPropTokenTest.class, WeildTokenTest.class,
	WtTokenTest.class})
