...
public class Add512Lst_Skill extends AbstractToken implements
		CDOMCompatibilityToken<CDOMObject>
{
			...
			throws PersistenceLayerException
	{
		...
		String feats = value.substring(6, endParenLoc);
		String count;
		...
		return context.processSubToken(cdo, getTokenName(), "SKILL", count
				+ "|" + feats);
	}
