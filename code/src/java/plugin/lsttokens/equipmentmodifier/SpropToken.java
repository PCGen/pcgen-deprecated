		...
		EquipmentModifierLstToken
{
	...
	public String unparse(LoadContext context, EquipmentModifier mod)
	{
		...
		HashMapToList<Set<Prerequisite>, SpecialProperty> m =
				new HashMapToList<Set<Prerequisite>, SpecialProperty>();
		...
		{
			List<SpecialProperty> props = m.getListFor(prereqs);
			if (needSpacer)
			{
				sb.append('\t');
			}
			...
			for (SpecialProperty sp : props)
			{
				if (needBar)
				{
					sb.append(Constants.PIPE);
				}
				sb.append(sp.getKeyName());
