...
/**
 * Handles the FRACTIONALPOOL token on an ABILITYCATEGORY line.
 * 
 * @author boomer70 <boomer70@yahoo.com>
 * 
 * @since 5.11.1
 */
public class FractionalPoolToken implements AbilityCategoryLstToken,
		CDOMPrimaryToken<CDOMAbilityCategory>
{
	...
	{
		return "FRACTIONALPOOL"; //$NON-NLS-1$
	}
			...
			String value)
	{
		...
		context.getObjectContext().put(adj, ObjectKey.FRACTIONAL_POOL, set);
		return true;
	}
