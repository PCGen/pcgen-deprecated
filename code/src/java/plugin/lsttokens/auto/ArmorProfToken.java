...
public class ArmorProfToken implements AutoLstToken
{
	...
	public boolean parse(LoadContext context, CDOMObject obj, String value)
	{
		...
		while (tok.hasMoreTokens())
		{
			...
			{
				CDOMGroupRef<ArmorProf> ref =
						context.ref.getCDOMTypeReference(ArmorProf.class, aProf
							.substring(5).split("."));
			...
			{
				CDOMSimpleSingleRef<ArmorProf> ref =
						context.ref.getCDOMReference(ArmorProf.class, aProf);
				/*
