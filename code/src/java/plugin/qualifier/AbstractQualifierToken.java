 ...
 * 
 * Created on Mar 9, 2008, 3:01:59 AM
 */
package plugin.qualifier;
 ...
 */
public abstract class AbstractQualifierToken<T extends CDOMObject> implements
        ChooseLstQualifierToken<T>
{

    protected PrimitiveChoiceFilter<T> pcs = null;
    ...
    public boolean initialize(LoadContext context,
                               Class<T> cl, String condition, String value)
    {
        if (condition != null)
        {
