...
public class GroupRestriction<T extends PObject> implements Restriction<T>
{

	private final CDOMGroupRef<T> target;

	private final Class<T> targetClass;

	private final boolean negated;

	public GroupRestriction(Class<T> cl, CDOMGroupRef<T> ref)
	{
		this(cl, ref, false);
	}

	public GroupRestriction(Class<T> cl, CDOMGroupRef<T> ref, boolean negate)
	{
		target = ref;
		targetClass = cl;
		negated = negate;
	...
	public boolean qualifies(T pro)
	{
		...
		return target.contains(pro) ^ negated;
	}
