...
public class PCGraphHoldsEdge extends AbstractPCGraphEdge implements
		PCGraphEdge
{

	private final String source;

	public PCGraphHoldsEdge(PrereqObject node1, PrereqObject node2,
		String sourceToken)
	{
		super(node1, node2);
		source = sourceToken;
	...
	{
		if (!(o instanceof PCGraphHoldsEdge))
		{
			return false;
		}
		if (this == o)
		...
		PCGraphHoldsEdge other = (PCGraphHoldsEdge) o;
