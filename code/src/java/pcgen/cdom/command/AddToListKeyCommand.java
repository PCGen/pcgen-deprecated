...
import pcgen.cdom.edit.ListKeyEdit;
 ...
 * invoked.
 */
public class AddToListKeyCommand<T> implements CDOMCommand
{
	 ...
	 *            CDOMObject.
	 */
	public AddToListKeyCommand(String editPresentationName,
		CDOMObject cdomObject, ListKey<T> key, T value)
	{
		...
		if (value == null)
		{
			throw new IllegalArgumentException("Value for Add cannot be null");
		}
	...
	{
		cdo.addToListFor(listKey, stringValue);
		return new ListKeyEdit<T>(name, cdo, listKey, stringValue, true);
	}
