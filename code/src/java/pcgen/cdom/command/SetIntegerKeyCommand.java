...
import pcgen.cdom.edit.IntegerKeyEdit;
...
public class SetIntegerKeyCommand implements CDOMCommand
{
	...
	{
		Integer current = cdo.get(integerKey);
		if (IntegerValue == null)
		{
			cdo.remove(integerKey);
		}
		else
		{
			cdo.put(integerKey, IntegerValue);
		}
		return new IntegerKeyEdit(name, cdo, integerKey, current, IntegerValue);
	}
