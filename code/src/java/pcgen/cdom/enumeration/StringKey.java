...
public enum StringKey {
	 ...
	 MINDEVVER,
	 COMPAT_PROFICIENCY,
	 COMPAT_PROFICIENCY_SOURCE,
	 COMPAT_CHOICE,
	 COMPAT_CHOICE_SOURCE,
	 PENALTYVAR,
	 PLURAL,
	 DISPLAY_LOCATION,
	 ABB,
