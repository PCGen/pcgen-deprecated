 ...
 */
public final class SpellContainingEqType implements TypeSafeConstant
{

	/**
	 * This Map contains the mappings from Strings to the Type Safe Constant
	 */
	private static CaseInsensitiveMap<SpellContainingEqType> typeMap;
	...
	private SpellContainingEqType(String name)
	{
	 ...
	 */
	public static SpellContainingEqType getConstant(String s)
	{
		if (typeMap == null)
		{
			typeMap = new CaseInsensitiveMap<SpellContainingEqType>();
		}
		SpellContainingEqType o = typeMap.get(s);
		if (o == null)
		{
			o = new SpellContainingEqType(s);
			typeMap.put(s, o);
		}
		return o;
	}
	 ...
	 * @return The Constant for the given name
	 */
	public static SpellContainingEqType valueOf(String s)
	{
		if (typeMap == null)
		{
			typeMap = new CaseInsensitiveMap<SpellContainingEqType>();
	 ...
	 */
	public static Collection<SpellContainingEqType> getAllConstants()
	{
		if (typeMap == null)
		{
			return null;
