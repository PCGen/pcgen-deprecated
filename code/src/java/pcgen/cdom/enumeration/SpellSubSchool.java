 ...
 */
public final class SpellSubSchool implements TypeSafeConstant
{

	/**
	 * This Map contains the mappings from Strings to the Type Safe Constant
	 */
	private static CaseInsensitiveMap<SpellSubSchool> typeMap;
	 ...
	 */
	public static SpellSubSchool getConstant(String s)
	{
		if (typeMap == null)
		{
			typeMap = new CaseInsensitiveMap<SpellSubSchool>();
		}
		SpellSubSchool o = typeMap.get(s);
		if (o == null)
		{
			o = new SpellSubSchool(s);
			typeMap.put(s, o);
		}
		return o;
	}
	 ...
	 * @return The Constant for the given name
	 */
	public static SpellSubSchool valueOf(String s)
	{
		if (typeMap == null)
		{
			typeMap = new CaseInsensitiveMap<SpellSubSchool>();
	 ...
	 */
	public static Collection<SpellSubSchool> getAllConstants()
	{
		if (typeMap == null)
		{
			return null;
