 ...
 */
public final class Pantheon implements TypeSafeConstant
{

	/**
	 * This Map contains the mappings from Strings to the Type Safe Constant
	 */
	private static CaseInsensitiveMap<Pantheon> typeMap;
	...
	public static Pantheon getConstant(String s)
	{
		if (typeMap == null)
		{
			typeMap = new CaseInsensitiveMap<Pantheon>();
		}
	 ...
	 */
	public static Collection<Pantheon> getAllConstants()
	{
		if (typeMap == null)
		{
			return null;
