 ...
 */
public final class AlignmentType implements TypeSafeConstant
{

	/**
	 * This Map contains the mappings from Strings to the Type Safe Constant
	 */
	private static CaseInsensitiveMap<AlignmentType> typeMap;
	 ...
	 */
	public static AlignmentType getConstant(String s)
	{
		if (typeMap == null)
		{
			typeMap = new CaseInsensitiveMap<AlignmentType>();
		}
		AlignmentType o = typeMap.get(s);
		if (o == null)
		{
			o = new AlignmentType(s);
			typeMap.put(s, o);
		}
		return o;
	}
	 ...
	 * @return The Constant for the given name
	 */
	public static AlignmentType valueOf(String s)
	{
		if (typeMap == null)
		{
			typeMap = new CaseInsensitiveMap<AlignmentType>();
	 ...
	 */
	public static Collection<AlignmentType> getAllConstants()
	{
		if (typeMap == null)
		{
			return null;
