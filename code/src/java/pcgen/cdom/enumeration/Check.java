 ...
 */
public final class Check implements TypeSafeConstant
{

	/**
	 * This Map contains the mappings from Strings to the Type Safe Constant
	 */
	private static CaseInsensitiveMap<Check> typeMap;
	 ...
	 */
	public static Check getConstant(String s)
	{
		if (typeMap == null)
		{
			typeMap = new CaseInsensitiveMap<Check>();
		}
		Check o = typeMap.get(s);
		if (o == null)
		{
			o = new Check(s);
			typeMap.put(s, o);
	 ...
	 */
	public static Collection<Check> getAllConstants()
	{
		if (typeMap == null)
		{
			return null;
