 ...
 */
public final class RacePantheon implements TypeSafeConstant
{

	/**
	 * This Map contains the mappings from Strings to the Type Safe Constant
	 */
	private static CaseInsensitiveMap<RacePantheon> typeMap;
	...
	private RacePantheon(String name)
	{
	 ...
	 */
	public static RacePantheon getConstant(String s)
	{
		if (typeMap == null)
		{
			typeMap = new CaseInsensitiveMap<RacePantheon>();
		}
		RacePantheon o = typeMap.get(s);
		if (o == null)
		{
			o = new RacePantheon(s);
			typeMap.put(s, o);
		}
		return o;
	}
	 ...
	 * @return The Constant for the given name
	 */
	public static RacePantheon valueOf(String s)
	{
		if (typeMap == null)
		{
			typeMap = new CaseInsensitiveMap<RacePantheon>();
	 ...
	 */
	public static Collection<RacePantheon> getAllConstants()
	{
		if (typeMap == null)
		{
			return null;
