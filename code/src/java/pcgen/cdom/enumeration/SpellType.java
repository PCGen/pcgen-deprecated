 ...
 */
public final class SpellType implements TypeSafeConstant
{

	/**
	 * This Map contains the mappings from Strings to the Type Safe Constant
	 */
	private static CaseInsensitiveMap<SpellType> typeMap;
	 ...
	 */
	public static SpellType getConstant(String s)
	{
		if (typeMap == null)
		{
			typeMap = new CaseInsensitiveMap<SpellType>();
		}
		SpellType o = typeMap.get(s);
		if (o == null)
		{
			o = new SpellType(s);
			typeMap.put(s, o);
	 ...
	 * @return The Constant for the given name
	 */
	public static SpellType valueOf(String s)
	{
		if (typeMap == null)
		{
			typeMap = new CaseInsensitiveMap<SpellType>();
	 ...
	 */
	public static Collection<SpellType> getAllConstants()
	{
		if (typeMap == null)
		{
			typeMap = new CaseInsensitiveMap<SpellType>();
