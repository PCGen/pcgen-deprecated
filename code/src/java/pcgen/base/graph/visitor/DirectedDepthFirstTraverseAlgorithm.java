		...
		extends DepthFirstTraverseAlgorithm<N, ET>
{
	...
	/**
	 * Creates a new DirectedDepthFirstTraverseAlgorithm to traverse
	 * the given Graph.
	 * 
	 * @param g The Graph this DirectedDepthFirstTraverseAlgorithm 
	 * will traverse.
	 */
	...
	/**
	 * Indicates if this DirectedDepthFirstTraverseAlgorithm should
