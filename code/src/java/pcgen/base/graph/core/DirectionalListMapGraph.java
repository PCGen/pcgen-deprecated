 ...
 * 
 * WARNING: This DirectionalListMapGraph contains a CACHE which uses the Nodes
 * as a KEY. Due to the functioning of a Map (it uses the .hashCode() method),
 * if a Node is modified IN PLACE in the Graph (without being removed and
 * readded), it WILL cause the caching to FAIL, because the cache will have
		...
		AbstractListMapGraph<N, ET> implements DirectionalGraph<N, ET>
{
	...
	/**
	 * Creates a new, empty DirectionalListMapGraph
	 */
	public DirectionalListMapGraph()
	{
		super();
	}
	 ...
	 * reference to the List Object is maintained by DirectionalListMapGraph.
