 ...
 *   This is a derivative of DirectionalListMapGraph (c) 2005-2007
 * 
 ...
 * 
 * A DirectionalIdentityEdgeMapGraph is a DirectionalGraph. Thus, it requires
 * that all Edges added to the Graph are DirectionalEdges. Failure to abide by
 * this restriction will result in the addition of the edge failing.
 * 
 ...
 * 
 * WARNING: This DirectionalIdentityEdgeMapGraph contains a CACHE which uses the
 ...
 * DirectionalIdentityEdgeMapGraph.
 */
public class DirectionalIdentityEdgeMapGraph<N, ET extends DirectionalEdge<N>>
		extends AbstractIdentityEdgeMapGraph<N, ET> implements
		DirectionalGraph<N, ET>
{

	/**
	 * Creates a new, empty DirectionalIdentityEdgeMapGraph
	 */
	public DirectionalIdentityEdgeMapGraph()
	{
		super();
	}
	 ...
	 * DirectionalIdentityEdgeMapGraph. However, the Edges contained in the List
