...
public final class Logging
{
	 ...
	 * 
	 * @param param1
	 *            String information message (usually variable)
	 * @param param2
	 *            Object information message (usually value)
	 */
	...
	public static void errorPrintLocalised(final String aKey)
	{
		...
		final String msg = PropertyFactory.getProperty(aKey);
	...
	{
		errorPrint(PropertyFactory.getProperty(s));
		thr.printStackTrace(System.err);
	}
