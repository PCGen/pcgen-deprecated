 ...
 */
public class PCGenToolBar extends JToolBar
{
    ...
    private void initComponents()
    {
        ...
        add(ToolBarUtilities.createToolBarButton(actionMap.get(PCGenActionMap.PRINT_PREVIEW_COMMAND)));
        ...
        add(ToolBarUtilities.createToolBarButton(actionMap.get(PCGenActionMap.OPTIONS_COMMAND)));
        addSeparator();
