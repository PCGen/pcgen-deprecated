...
public class SpinningTabbedPane extends JTabbedPane
{
    ...
    private static final String[] labels =
        ...
        PropertyFactory.getString("in_left"),
        PropertyFactory.getString("in_bottom"),
        PropertyFactory.getString("in_right"),
        PropertyFactory.getString("in_beginning"), // move left/right
        PropertyFactory.getString("in_left"),
        PropertyFactory.getString("in_end"),
        PropertyFactory.getString("in_right"),
        PropertyFactory.getString("in_top"), // move up/down
        PropertyFactory.getString("in_up"),
        PropertyFactory.getString("in_bottom"),
        PropertyFactory.getString("in_down"),
        ...
        null,
        null,
        PropertyFactory.getString("in_ungroupTop"), // ungroup child
        PropertyFactory.getString("in_ungroupLeft"),
        PropertyFactory.getString("in_ungroupBottom"),
        PropertyFactory.getString("in_ungroupRight"),
        PropertyFactory.getString("in_ungroupTop"), // ungroup self
        PropertyFactory.getString("in_ungroupLeft"),
        PropertyFactory.getString("in_ungroupBottom"),
        PropertyFactory.getString("in_ungroupRight"),
        PropertyFactory.getString("in_ungroupUp"), // ungroup single
        PropertyFactory.getString("in_ungroupLeft"),
        PropertyFactory.getString("in_ungroupDown"),
        PropertyFactory.getString("in_ungroupRight")
    };
    ...
    private static final String[] tips =
            {
        PropertyFactory.getString("in_spinTips1"),
        PropertyFactory.getString("in_spinTips2"),
        PropertyFactory.getString("in_spinTips3"),
        PropertyFactory.getString("in_spinTips4"),
        PropertyFactory.getString("in_spinTips5"),
        PropertyFactory.getString("in_spinTips6"),
        PropertyFactory.getString("in_spinTips7"),
        PropertyFactory.getString("in_spinTips8"),
        PropertyFactory.getString("in_spinTips9"),
        PropertyFactory.getString("in_spinTips10"),
        PropertyFactory.getString("in_spinTips11"),
        PropertyFactory.getString("in_spinTips12"),
        PropertyFactory.getString("in_spinTips13"),
        PropertyFactory.getString("in_spinTips14"),
        PropertyFactory.getString("in_spinTips15"),
        PropertyFactory.getString("in_spinTips16"),
        PropertyFactory.getString("in_spinTips17"),
        PropertyFactory.getString("in_spinTips18"),
        PropertyFactory.getString("in_spinTips19"),
        PropertyFactory.getString("in_spinTips20"),
        PropertyFactory.getString("in_spinTips21"),
        PropertyFactory.getString("in_spinTips22"),
        PropertyFactory.getString("in_spinTips23"),
        PropertyFactory.getString("in_spinTips24"),
        PropertyFactory.getString("in_spinTips25"),
        PropertyFactory.getString("in_spinTips26"),
        PropertyFactory.getString("in_spinTips27"),
        PropertyFactory.getString("in_spinTips28"),
        PropertyFactory.getString("in_spinTips29"),
        PropertyFactory.getString("in_spinTips30"),
        PropertyFactory.getString("in_spinTips31"),
        PropertyFactory.getString("in_spinTips32")
    };
...
//	    to.setDisplayedMnemonicIndexAt(toIndex, displayedMnemonicIndex);
    ...
    private class CloseAction extends IndexedAction
    {
        ...
        {
            super(index, PropertyFactory.getString("in_close"),
                  Utilities.CLOSE_ICON,
                  PropertyFactory.getMnemonic("in_mn_close"));
        }
    ...
    private class LockAction extends IndexedAction
    {
        ...
        {
            super(index, PropertyFactory.getString("in_lock"),
                  Utilities.LOCK_ICON, PropertyFactory.getMnemonic("in_mn_lock"));
        }
    ...
    private class NewAction extends IndexedAction
    {
        ...
        public NewAction()
        {
            super(0, PropertyFactory.getString("in_new"), Utilities.NEW_ICON,
                  PropertyFactory.getMnemonic("in_mn_new"));
        }
    ...
    private class RenameAction extends IndexedAction
    {
        ...
        {
            super(index, PropertyFactory.getString("in_rename") + "...", null,
                  PropertyFactory.getMnemonic("in_mn_rename"));
            this.evt = e;
        }
    ...
    private class UnlockAction extends IndexedAction
    {
        ...
        {
            super(index, PropertyFactory.getString("in_unlock"),
                  Utilities.LOCK_ICON,
                  PropertyFactory.getMnemonic("in_mn_unlock"));
        }
