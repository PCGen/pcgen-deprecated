				...
				statSelectionBox.addItemListener(
						new ItemListener()
						{
							...
							public void itemStateChanged(ItemEvent e)
							{
								...
								{
									@SuppressWarnings("unchecked")
									StatGenerationMethod statGenerator = (StatGenerationMethod) e.getItem();
									StatTableModel model = statTablePane.getModel();
...
//
//        List<StatGenerationMethod> levelGenerators = creationManager.getClassLevelGenerators();
...
//        levelComboBox3.setModel(createComboBoxModel(levelGenerators));
	...
	private class StatSpinnerModel extends AbstractSpinnerModel
	{
		...
		public StatSpinnerModel(PurchaseMethod purchaseMode,
								 Integer score)
		{
