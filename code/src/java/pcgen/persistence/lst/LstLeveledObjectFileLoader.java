 ...
 *
 * Current Ver: $Revision: 2135 $ <br>
 * Last Editor: $Author: thpr $ <br>
		...
		Observable
{
	 ...
	 */
	public LstLeveledObjectFileLoader()
	{
		super();
	}
	 ...
	 * 
	 * @see pcgen.persistence.lst.LstLeveledObjectFileLoader#includeObject(PObject)
	 * @see pcgen.persistence.lst.LstLeveledObjectFileLoader#finishObject(PObject)
