...
;       	SectionEnd
	...
	SetOutPath "$INSTDIR\${APPDIR}\data\alpha\fantasycommunitycouncil\"
	...
	SetOutPath "$INSTDIR\${APPDIR}\data\alpha\mythicdreamsstudios\"
	...
	SetOutPath "$INSTDIR\${APPDIR}\data\alpha\paradigmconcepts\"
