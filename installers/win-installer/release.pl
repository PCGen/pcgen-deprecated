...
Readonly my $SRC_BRANCH         => 'E:/Projects/pcgen_v5_10';
...
Readonly my @FILES_TO_SKIP => (
    ...
    qr{ [/] cvs [/]             }xmsi,  # /cvs
    qr{ [/] .svn [/]            }xmsi,  # /cvs
#    qr{ [/] alpha [/]           }xmsi,  # /alpha directory is not included in the main release
#    qr{ [/] customsources [/]   }xmsi,  # /coustomsources (for files generated by PCGEN)
...
if ( -e "$DEST_BASE_FOLDER/nsis_dir/Local/.svn" ) {
